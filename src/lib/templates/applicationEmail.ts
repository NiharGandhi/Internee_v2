														...
														<tr>
															<td class="pad" style="padding-bottom:10px;padding-left:10px;padding-right:10px;">
																<div style="color:#454562;font-family:'Roboto',Tahoma,Verdana,Segoe,sans-serif;font-size:34px;line-height:120%;text-align:center;mso-line-height-alt:40.8px;">
																	<p style="margin: 0; word-break: break-word;"><span>Application for {{</span>internshipName<span>}}</span></p>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad">
																<div style="color:#101112;direction:ltr;font-family:Arial, 'Helvetica Neue', Helvetica, sans-serif;font-size:16px;font-weight:400;letter-spacing:0px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
																	...
																	<p style="margin: 0; margin-bottom: 16px;">Education Level: {{educationLevel}}</p>
																	<p style="margin: 0; margin-bottom: 16px;">Institution of Study: {{institutionName}}</p>
																	<p style="margin: 0;">Skill: {{skills}}</p>
																</div>
															</td>
														</tr>
													</table>
